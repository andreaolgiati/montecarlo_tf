...
class Rule(ABC):
    def __init__(self, base_period, other_periods=None):
        self.base_period = base_period
        self.other_periods = other_periods

        self.periods = [base_period]
    ...
    @abstractmethod
    # returns a list of RequiredTensor objects, one for each period
    ...
    @staticmethod
    def _fetch_tensors_for_periods(req_tensors_requests):
    ...
    def invoke(self, period, traces, storage_handler=None, **kwargs):
        ...
        self.base_period.wait_for_steps([period])
